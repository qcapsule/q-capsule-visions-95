...
import { Q95XFloorPlan } from "@/components/Q95XFloorPlan";
import { ImageWithTransition } from "@/components/ImageWithTransition";
import { capsules } from "@/data/capsules";

// Get Q95X capsule data
const q95xCapsule =
  capsules.find((capsule) => capsule.name === "Q95X") || capsules[2];

export const Q95XCapsulePage = forwardRef<HTMLElement>((props, ref) => {
  const navigate = useNavigate();
  const [searchParams] = useSearchParams();
  const fromCapsule = searchParams.get("from") || "q95x";
  ...
  const handleDownload = () => {
    ...
    console.log("Download Q95X specifications");
  };

  const handleShare = () => {
    // Share functionality
    console.log("Share Q95X page");
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(/src/assets/q95x-capsulel.png)`,
          }}
        />

        {/* Main Background Image */}
        <ImageWithTransition
          src={q95xCapsule.images[0]}
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            >
              ...
              <p className="text-xl text-white/70 max-w-2xl mx-auto">
                Detailed technical specifications and dimensions for the Q95X
                capsule
              </p>
            </motion.div>
        ...
        <section className="relative py-32">
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            >
              ...
              <p className="text-xl text-white/70 max-w-2xl mx-auto">
                Advanced features and technologies integrated into the Q95X
                design
              </p>
            </motion.div>

            <div className="grid md:grid-cols-3 gap-6">
              {q95xCapsule.features.slice(0, 3).map((feature, index) => (
                <motion.div
                  key={feature}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            >
              <h2 className="text-5xl lg:text-6xl font-bold text-white mb-6">
                Ready to Experience Q95X?
              </h2>
              <p className="text-xl text-white/70 mb-12 max-w-2xl mx-auto">
                Schedule a consultation to learn more about the Q95X capsule and
...
Q95XCapsulePage.displayName = "Q95XCapsulePage";
