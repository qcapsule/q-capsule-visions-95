...
import { Q115XFloorPlan } from "@/components/Q115XFloorPlan";
import { ImageWithTransition } from "@/components/ImageWithTransition";
import { capsules } from "@/data/capsules";

// Get Q115X capsule data
const q115xCapsule =
  capsules.find((capsule) => capsule.name === "Q115X") || capsules[3];

export const Q115XCapsulePage = forwardRef<HTMLElement>((props, ref) => {
  const navigate = useNavigate();
  const [searchParams] = useSearchParams();
  const fromCapsule = searchParams.get("from") || "q115x";
  ...
  const handleDownload = () => {
    ...
    console.log("Download Q115X specifications");
  };

  const handleShare = () => {
    // Share functionality
    console.log("Share Q115X page");
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(/src/assets/q115x-capsule1.png)`,
          }}
        />

        {/* Main Background Image */}
        <ImageWithTransition
          src={q115xCapsule.images[0]}
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            >
              ...
              <p className="text-xl text-white/70 max-w-2xl mx-auto">
                Detailed technical specifications and dimensions for the Q115X
                capsule
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="text-white/70 text-sm">Master + 2 guest</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-3xl font-bold text-white mb-2">2</p>
                <p className="text-white/70 text-sm">Covered spaces</p>
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-32">
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            >
              ...
              <p className="text-xl text-white/70 max-w-2xl mx-auto">
                Advanced features and technologies integrated into the Q115X
                design
              </p>
            </motion.div>

            <div className="grid md:grid-cols-3 gap-6">
              {q115xCapsule.features.slice(0, 3).map((feature, index) => (
                <motion.div
                  key={feature}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            >
              <h2 className="text-5xl lg:text-6xl font-bold text-white mb-6">
                Ready to Experience Q115X?
              </h2>
              <p className="text-xl text-white/70 mb-12 max-w-2xl mx-auto">
                Schedule a consultation to learn more about the Q115X capsule
                and how it can fit your lifestyle.
              </p>
...
Q115XCapsulePage.displayName = "Q115XCapsulePage";
