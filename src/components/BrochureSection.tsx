...
export const BrochureSection = forwardRef<HTMLElement>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <div className="brochure-overlay absolute inset-0 bg-black/5 z-0"></div>

      {/* Main Content - Centered */}
      <div className="brochure-content container mx-auto px-6 relative z-10 flex flex-col justify-between h-full py-8">
        {/* Top Content */}
