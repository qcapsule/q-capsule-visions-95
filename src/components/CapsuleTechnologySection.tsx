...
function CapsuleTechnologyModel() {
...
interface CapsuleTechnologySectionProps {
  className?: string;
}

export const CapsuleTechnologySection = ({ className }: CapsuleTechnologySectionProps) => {
  return (
