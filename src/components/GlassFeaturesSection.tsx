  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Main Content - Stacked Corner Glass Elements with Features */}
        <div className="relative flex-1 min-h-[800px] lg:min-h-[1000px] ">
          ...
          {glassFeatures.map((feature, index) => {
            ...
            // Adjust connection width to account for glass-corners image width (approximately 40-60px)
        ...
        <motion.div
          className="relative w-full max-w-3xl mx-auto -mt-16 lg:-mt-40"
