...
export const AboutSection = forwardRef<HTMLElement>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <div className="about-overlay absolute inset-0 bg-black/5 z-0"></div>

      {/* Main Content - Centered */}
      <div className="about-content container mx-auto px-6 relative z-10 flex flex-col justify-between h-full py-8">
        {/* Top Content */}
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center max-w-6xl">
            <h2 className="text-5xl lg:text-7xl font-bold leading-tight text-white drop-shadow-lg mb-6">
              About{" "}
              <span className="text-white drop-shadow-lg">Q Capsules</span>
            </h2>
            ...
            <p className="text-xl lg:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed drop-shadow-md mb-8">
              ...
              living solutions that combine innovation, sustainability, and
              luxury in every capsule we create.
            </p>
